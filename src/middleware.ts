    ...
    const routeProtections: RouteProtection[] = [
        {
            ...
            routes: [
                ...
                "/api/dropshipper/shopify/registration/custom-privacy/customer-delete",
                "/api/dropshipper/shopify/registration/custom-privacy/data-request",
                "/api/dropshipper/shopify/registration/custom-privacy/shop-delete",
