 ...
 const searchParams = useSearchParams();
  ...
  const fetchPincodes = useCallback(async () => {
    ...
    try {
        ...
        const pinCode = result?.badPincode || {};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/bad-pincode/${id}`, {
        method: "PUT",
      ...
      Swal.fire("Updating...", "Bad Pincode Has been Updated successfully!", "success").then(() => {
